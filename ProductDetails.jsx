            ...
            <div className="col-lg-8 col-xl-9">
              <div className="row g-4">
                ...
                <div className="col-lg-6">
                  ...
                  <a href="#" className="btn border border-primary rounded-pill px-4 py-2 mb-4 text-primary"><i className="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                </div>
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-lg-12">
                      <div className="d-flex justify-content-between py-3 mb-5">
                        ...
                        <a href="#" className="btn border border-primary text-primary rounded-pill px-4 py-3"> Post Comment</a>
                      </div>
                    </div>
                  </div>
                </form>
              ...
              <div className="border border-primary rounded position-relative vesitable-item">
                ...
                <div className="p-4 pb-0 rounded-bottom">
                  ...
                  <div className="d-flex justify-content-between flex-lg-wrap">
                    ...
                    <a href="#" className="btn border border-primary rounded-pill px-3 py-1 mb-4 text-primary"><i className="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                  </div>
                </div>
              </div>
              <div className="border border-primary rounded position-relative vesitable-item">
