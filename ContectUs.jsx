        ...
        <>
            ...
            <div className="container-fluid page-header py-5">
                ...
                <ol className="breadcrumb justify-content-center mb-0">
                    ...
                    <li className="breadcrumb-item active text-white">Contect</li>
                </ol>
            </div>
                        ...
                        <div className="row g-4">
                            ...
                            <div className="col-lg-7">
                                <form action="" className="">
                                    ...
                                    <button className="w-100 btn form-control border-primary py-3 bg-white text-primary " type="submit">Submit</button>
                                </form>
                            </div>
