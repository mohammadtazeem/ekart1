...
export default function UpdateProduct() {
    ...
    function getInputFile(e) {
        ...
        setData((old) => {
            return {
                ...old,
                [name]: files[0].name //  remove this line in when connect with real server
                // [name]: files[0] // use this line in when connect with real server
            }
        })
    }
    function postData(e) {
                        ...
                        <form onSubmit={postData}>
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="color" onChange={getInputData} className='form-control' placeholder='Product Color' value={data.name}/>
                                    {show ? <p className='text-danger text-capitalize my-2'>{errorMessages.color}</p> : ""}
                                </div>
                                <div className="col-md-6 mb-3">
                                    <label>Size<span className='text-danger'>*</span></label>
                                    <input type="text" name="size" onChange={getInputData} className='form-control' placeholder='Product Size' value={data.name}/>
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="baseprice" onChange={getInputData} className='form-control' placeholder='Base Price' value={data.name}/>
                                ...
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="discount" onChange={getInputData} className='form-control' placeholder='Discount' value={data.name}/>
                            ...
                            <div className="mb-3">
                                ...
                                <Editor
                                    apiKey='ofj0lr4f0zddnset2860wsyq5aepmozvo4eqn9dpo1b9slvb'
