     ...
     {/* <!-- Footer Start --> */}
        <div className="container-fluid bg-dark text-white-50 footer pt-5 mt-5">
            <div className="container py-5">
                <div className="pb-4 mb-4" style={{bordeBottom: "1px solid rgba(226, 175, 24, 0.5)"}}>
                ...
                <div className="row g-5">
                    <div className="col-lg-3 col-md-6">
                        <div className="footer-item">
                            ...
                            <p className="text-light mb-4">typesetting, remaining essentially unchanged. It was 
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="d-flex flex-column text-start footer-item">
                           ...
                           <Link className="btn-link text-light" to="/contect">Contact</Link>
                           <Link className="btn-link text-light" to="/testimonial">Testimonial</Link>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="footer-item">
                            ...
                            <p className="text-light">Email: <a className="text-light" href="mailto:mohdtazeem5623@gmail.com">mohdtazeem5623@gmail.com</a></p>
                            <p className="text-light">Phone: <a className="text-light" href="tel:8307808627">+91-8307808627</a></p>
                            <p className="text-light">Phone: <a className="text-light" href="https://wa.me/8307808627">+91-8307808627</a></p>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span className="text-light"><a className="text-light" href="#"><i className="fas fa-copyright text-light me-2"></i>Your Site Name</a>, All right reserved.</span>
                    </div>
